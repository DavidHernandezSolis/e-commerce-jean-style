<div class="col xl12 l12 m10 s12 font-estilo " style="padding: 15px;">

	<?php 

		echo '
				<div class="row navegacion-cp" style="padding-left:50px;;"  >
					<span>
						<a href="index.php"><b class="error404">Inicio</b></a> / <b class="error404">'.$rutas[0].'</b> / <b class="error404">'.$rutas[2].'</b>  ...
					</span>
				</div>				
		';
		/*=============================================
		...
		$productosVitrina = null;
		$listaProductos = [];
		$controladorCliente = new ControladorCliente();
		if (isset($rutas[2])) {
			/* consulta de productos dependiendo de que parametros se lleno anteriormente */
			$busqueda = $rutas[2];
			$productosVitrina =$controladorCliente->buscarVitrinaProductosControl($busqueda, $base, $tope);
		//para listar el paginado
			$listaProductos = null;
			$listaProductos =  $controladorCliente->listarBusquedaProductosControl($busqueda);
		...
		if (!$productosVitrina) {/* sentencia para cuando no existe ningun producto en oferta o en nuevos o en alguna categoria*/
			echo '
				<div class="row center-align">
					...
					<h5>Intentar con otro pantalón</h5>
					<hr>
					<span><a href="'.$url.'index.php">INICIO</a></span>
				</div>
			';
		}else{
			echo '
					...
					if ($rutas[1] == 1) {
						...
						echo '<ul class="pagination center-align">';
							for ($i=1; $i <= 4; $i++) { 
								# code...
								echo '
									<li class="waves-effect"><a href="'.$url.$rutas[0].'/'.$i.'/'.$rutas[2].'">'.$i.'</a></li>
								';
							}
							echo '
									<li class="waves-effect disabled">. &nbsp;. &nbsp;.</li>
									<li class="waves-effect"><a href="'.$url.$rutas[0].'/'.$pagProductos.'/'.$rutas[2].'">'.$pagProductos.'</a></li>
									<li class="waves-effect"><a href="'.$url.$rutas[0].'/2/'.$rutas[2].'"><i class="material-icons">chevron_right</i></a></li>
								';
			...
			=============================================*/
						...
						echo '<ul class="pagination center-align">
									<li class=" waves-effect"><a href="'.$url.$rutas[0].'/'.($numPagActual - 1).'/'.$rutas[2].'"><i class="material-icons">chevron_left</i></a></li>';
							...
							echo '
									<li class="waves-effect disabled">. &nbsp;. &nbsp;.</li>
									<li class="waves-effect"><a href="'.$url.$rutas[0].'/'.$pagProductos.'/'.$rutas[2].'">'.$pagProductos.'</a></li>
									<li class="waves-effect"><a href="'.$url.$rutas[0].'/'.($numPagActual + 1).'/'.$rutas[2].'"><i class="material-icons">chevron_right</i></a></li>
								';
			...
			=============================================*/
						...
						$numPagActual =$rutas[1];
						echo '<ul class="pagination center-align">
									<li class="disabled"><a href="'.$url.$rutas[0].'/'.($numPagActual - 1).'/'.$rutas[2].'"><i class="material-icons">chevron_left</i></a></li>
									<li class="waves-effect"><a href="'.$url.$rutas[0].'/'.$rutas[2].'/1">1</a></li>
									<li class="waves-effect disabled">.&nbsp; .&nbsp; .</li>';
							for ($i=$numPagActual; $i <=($numPagActual + 3); $i++) { 
								# code...
								echo '
			...
			=============================================*/
						...
						echo '<ul class="pagination center-align">
									<li class="disabled"><a href="'.$url.$rutas[0].'/'.($numPagActual - 1).'/'.$rutas[2].'"><i class="material-icons">chevron_left</i></a></li>
									<li class="waves-effect"><a href="'.$url.$rutas[0].'/1/'.$rutas[2].'">1</a></li>
									<li class="waves-effect disabled">.&nbsp; .&nbsp; .</li>';
